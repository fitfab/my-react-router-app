...
export default function Home() {
  ...
  return (
    <div className="">
      ...
      <Carousel>
        {data.map((card, index) => (
          <div key={index} className="border-1 border-neutral-300 rounded-md p-6 w-[480px] overflow-hidden bg-white">
            <h2 className="text-1xl uppercase font-extrabold text-gray-600 underline  decoration-brand mb-4 decoration-4">
              {card.alt}
            </h2>
            <img src={card.src} alt={card.alt} width={card.width} height={card.height} />
